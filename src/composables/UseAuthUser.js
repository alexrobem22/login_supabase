...
export default function useAuthUser() {
    ...
    const login = async ({ email, password }) => {
        ...
        try {
            ...
            const { user, error, status } = await supabase.auth.signInWithPassword({ email: email, password: password })
    ...
    const loginWithSocialProvider = async (provider) => {
        ...
        try {
            ...
            throw new Error('Ocorreu um erro ao fazer login Social. Por favor, tente novamente.')
        }
    ...
    const logout = async () => {
        ...
        try {
            ...
            throw new Error('Ocorreu um erro ao fazer logout. Por favor, tente novamente.')
        }
    ...
    const register = async ({ name, email, password, ...meta }) => {
        ...
        try {
            ...
            throw new Error('Ocorreu um erro ao fazer register. Por favor, tente novamente.')
        }
    ...
    const update = async (data) => {
        ...
        try {
            ...
            throw new Error('Ocorreu um erro ao fazer update. Por favor, tente novamente.')
        }
    ...
    const sendPassowrdRestEmail = async (email) => {
        ...
        try {
            ...
            const { user, error, status } = await supabase.auth.api.resetPasswoardForEmail(email)
            if (error) throw error
            return user
